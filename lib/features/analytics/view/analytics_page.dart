...
class _AnalyticsPageState extends ConsumerState<AnalyticsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final allSpecialistsItem = _allSpecialistsItem(workerLabels);
    final specialists = workersAsync.maybeWhen(
      data: (response) => _specialistsFromWorkers(response.results, workerLabels),
      orElse: () => [allSpecialistsItem],
    );
      ...
      body: Column(
        children: [
          _AnalyticsHeader(
            ...
            allSpecialistsItem: allSpecialistsItem,
...
class _AnalyticsHeader extends StatelessWidget {
  const _AnalyticsHeader({
    ...
    required this.allSpecialistsItem,
  ...
  final SpecialistItem allSpecialistsItem;
          ...
          if (showSpecialistSelector) ...[
            ...
            if (selectedSpecialist.id != null)
              ...
              _AnalyticsAllSpecialistsSelector(
                ...
                specialists: specialists,
                selectedSpecialist: allSpecialistsItem,
          ...
          _AnalyticsSection(
            ...
            child: _AnalyticsMetricCardGrid(
              metrics: [
                ...
                if (data.existingClients != null && !data.workerScoped)
                  _AnalyticsMetricItem(
                    title: 'Постоянные',
                    value: '${data.existingClients}',
                  ),
                if (data.oneshotClients != null && !data.workerScoped)
                  _AnalyticsMetricItem(
                    title: 'Разовые',
